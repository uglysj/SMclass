...
rankingnews_box_list = rankingnews_wrap.find_all('div', {'class': 'rankingnews_box'})
print("여러개 개수 확인 :", len(rankingnews_box_list))

for list in rankingnews_box_list:
  print(list.find('strong', {'class': 'rankingnews_name'}).text)
